...
1. **Looks like a guidebook**, not a database. Each day a card. Each stop a photo, an address, and a few sentences about what you're walking into.
2. **Survives the drive.** Map tiles cached. Pages cached. Plans available even when the phone is in airplane mode in a canyon.
3. **Talks to the back seat.** A two-voice podcast, a trivia game, a playlist reward. Built for a phone mounted on the dashboard.
4. **Doesn't try to be a booking site.** We're not in that business. We just want the plan to be good.
...
If you've got a road trip coming up, [start one for free](/users/sign_up) and let us know what's missing.
